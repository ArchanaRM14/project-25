...
function keyPressed() {
  ...
  if(keyCode === 32){
    ...
    var arrow = new PlayerArrow(playerArcher.body.position.x,playerArcher.body.position.y,100,10)
    arrow.trajectory=[]
    Matter.Body.setAngle(arrow.body,playerArcher.body.angle+PI/2)
